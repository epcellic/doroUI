...
extern const uint8_t Dwave[];
extern const uint8_t picture[];
extern const uint8_t LED[];
extern const uint8_t game[];
extern const uint8_t usart[];

extern const uint8_t doro1[];
extern const uint8_t doro2[];
extern const uint8_t doro3[];

extern const uint8_t ADhelp[];
extern const uint8_t Usart[];
// 声明27x38的大数字字模数组
extern const uint8_t OLED_F27x38[][135];
